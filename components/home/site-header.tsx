...
export function SiteHeader({ ui, language, onLanguageChange }: SiteHeaderProps) {
  ...
  return (
    <header className="flex flex-wrap items-center justify-between gap-4 border-b border-[color:var(--line)] pb-5">
      ...
      <nav className="hidden flex-wrap items-center gap-4 text-sm text-[color:var(--ink-soft)] sm:flex sm:gap-6">
        <a
          href="#services"
      ...
      {isMenuOpen ? (
        <div className="w-full rounded-2xl border border-[color:var(--line)] bg-white/90 p-4 sm:hidden">
